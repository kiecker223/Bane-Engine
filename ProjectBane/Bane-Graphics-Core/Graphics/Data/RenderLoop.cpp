...
void RenderMeshMaterialBucket::AddDrawnMesh(const Mesh* pMesh, const Material* pMat, const float4x4& Transformation)
{
...
void RenderLoop::DrawMesh(const Mesh* pMesh, const Material* pMaterial, const float4x4& Transformation)
{
