...
ForceInline GFX_RASTER_DESC CreateDefaultGFXRasterDesc()
{
...
ForceInline GFX_DEPTH_STENCIL_DESC CreateDefaultGFXDepthStencilDesc()
{
...
ForceInline GFX_RENDER_TARGET_DESC CreateDefaultGFXRenderTargetDesc()
{
...
ForceInline uint TranslateItemFormatSize(EINPUT_ITEM_FORMAT Format)
{
	switch (Format)
	{
...
ForceInline uint GetLayoutDescSize(const GFX_INPUT_LAYOUT_DESC& InDesc)
{
	uint Result = 0;
...
ForceInline uint GetLayoutStride(IInputLayout* Layout)
{
