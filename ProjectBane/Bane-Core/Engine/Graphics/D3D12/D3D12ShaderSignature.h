...
ForceInline bool operator == (const D3D12_SHADER_PARAMETER& Left, const D3D12_SHADER_PARAMETER& Right)
{
...
public:
	...
	ForceInline void AddParameter(const D3D12_SHADER_PARAMETER& Parameter)
	{
	...
	ForceInline void AddStaticSampler(const D3D12_STATIC_SAMPLER_DESC& SamplerDesc)
	{
...
ForceInline bool operator == (const D3D12ShaderSignatureParameterList& Left, const D3D12ShaderSignatureParameterList& Right)
{
...
public:
	...
	ForceInline ESHADER_PARAMETER_TYPE GetLargestParameterType() const
	{
	...
	ForceInline uint GetLargestParameterSize() const
	{
	...
	ForceInline uint TotalParameterCount() const
	{
		uint Result = 0;
		Result += NumCBVs;
		Result += NumSRVs;
	...
	void Quantize();
	ForceInline D3D12ShaderItemData Quantized()
	{
