...
//	}
	...
	switch (NumOfLargestParam)
	{
		...
		case 2:
		{
			Tier = (bHasUAVs ? D3D12_SHADER_SIGNATURE_TIER_2CBV_2SRV_2SAMPLER : D3D12_SHADER_SIGNATURE_TIER_2CBV_2SRV_2UAV_2SAMPLER);
		} break;
		case 4:
		{
			Tier = (bHasUAVs ? D3D12_SHADER_SIGNATURE_TIER_4CBV_4SRV_4SAMPLER : D3D12_SHADER_SIGNATURE_TIER_4CBV_4SRV_4UAV_4SAMPLER);
		} break;
		case 8:
		{
			Tier = (bHasUAVs ? D3D12_SHADER_SIGNATURE_TIER_8CBV_8SRV_8SAMPLER : D3D12_SHADER_SIGNATURE_TIER_8CBV_8SRV_8UAV_8SAMPLER);
		} break;
		case 16:
		{
			Tier = (bHasUAVs ? D3D12_SHADER_SIGNATURE_TIER_16CBV_16SRV_16SAMPLER : D3D12_SHADER_SIGNATURE_TIER_16CBV_16SRV_16UAV_16SAMPLER);
		} break;
	}
	return Tier;
}
