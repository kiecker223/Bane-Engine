...
#pragma region Operators
	...
	{
		TT Result;
		Result[0][0] = p[0][0] * Rhs.p[0][0] + p[0][1] * Rhs.p[1][0] + p[0][2] * Rhs.p[2][0] + p[0][3] * Rhs.p[3][0];
		Result[0][1] = p[0][0] * Rhs.p[0][1] + p[0][1] * Rhs.p[1][1] + p[0][2] * Rhs.p[2][1] + p[0][3] * Rhs.p[3][1];
		Result[0][2] = p[0][0] * Rhs.p[0][2] + p[0][1] * Rhs.p[1][2] + p[0][2] * Rhs.p[2][2] + p[0][3] * Rhs.p[3][2];
		Result[0][3] = p[0][0] * Rhs.p[0][3] + p[0][1] * Rhs.p[1][3] + p[0][2] * Rhs.p[2][3] + p[0][3] * Rhs.p[3][3];
		Result[1][0] = p[1][0] * Rhs.p[0][0] + p[1][1] * Rhs.p[1][0] + p[1][2] * Rhs.p[2][0] + p[1][3] * Rhs.p[3][0];
		Result[1][1] = p[1][0] * Rhs.p[0][1] + p[1][1] * Rhs.p[1][1] + p[1][2] * Rhs.p[2][1] + p[1][3] * Rhs.p[3][1];
		Result[1][2] = p[1][0] * Rhs.p[0][2] + p[1][1] * Rhs.p[1][2] + p[1][2] * Rhs.p[2][2] + p[1][3] * Rhs.p[3][2];
		Result[1][3] = p[1][0] * Rhs.p[0][3] + p[1][1] * Rhs.p[1][3] + p[1][2] * Rhs.p[2][3] + p[1][3] * Rhs.p[3][3];
		Result[2][0] = p[2][0] * Rhs.p[0][0] + p[2][1] * Rhs.p[1][0] + p[2][2] * Rhs.p[2][0] + p[2][3] * Rhs.p[3][0];
		Result[2][1] = p[2][0] * Rhs.p[0][1] + p[2][1] * Rhs.p[1][1] + p[2][2] * Rhs.p[2][1] + p[2][3] * Rhs.p[3][1];
		Result[2][2] = p[2][0] * Rhs.p[0][2] + p[2][1] * Rhs.p[1][2] + p[2][2] * Rhs.p[2][2] + p[2][3] * Rhs.p[3][2];
		Result[2][3] = p[2][0] * Rhs.p[0][3] + p[2][1] * Rhs.p[1][3] + p[2][2] * Rhs.p[2][3] + p[2][3] * Rhs.p[3][3];
		Result[3][0] = p[3][0] * Rhs.p[0][0] + p[3][1] * Rhs.p[1][0] + p[3][2] * Rhs.p[2][0] + p[3][3] * Rhs.p[3][0];
		Result[3][1] = p[3][0] * Rhs.p[0][1] + p[3][1] * Rhs.p[1][1] + p[3][2] * Rhs.p[2][1] + p[3][3] * Rhs.p[3][1];
		Result[3][2] = p[3][0] * Rhs.p[0][2] + p[3][1] * Rhs.p[1][2] + p[3][2] * Rhs.p[2][2] + p[3][3] * Rhs.p[3][2];
		Result[3][3] = p[3][0] * Rhs.p[0][3] + p[3][1] * Rhs.p[1][3] + p[3][2] * Rhs.p[2][3] + p[3][3] * Rhs.p[3][3];
		return Result;
	}
